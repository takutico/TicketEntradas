                        ...
                        <tr:panelBorderLayout>
                            ...
                            <tr:panelHorizontalLayout>
                                ...
                                <tr:navigationPane hint="bar" styleClass="subMenu">
                                    <tr:commandNavigationItem text="Crear" action="#{menu.goNuevoTicket}" immediate="true"/>
                                    <%--tr:commandNavigationItem text="Modificar" action="#{menu.goBusquedaTicket}" immediate="true"/--%>
                                </tr:navigationPane>
                            </tr:panelHorizontalLayout>
                                ...
                                <tr:panelGroupLayout>
                                    ...
                                    <tr:panelFormLayout>
                                        <tr:outputText inlineStyle="font-size:12pt;text-align: left;"
                                            value="Desde la opción \"Emitir tickets\", se pueden emitir nuevos tickets."/>
                                    </tr:panelFormLayout>

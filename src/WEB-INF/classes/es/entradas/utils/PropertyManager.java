...
public class PropertyManager {
    ...
    private void readPropertyFile() {
        ...
        try {
            ...
            String path = PropertyManager.class.getResource("/").getPath()+ filename;
    ...
    public static synchronized PropertyManager getInstance() {
        if (propertyManager == null) {
            propertyManager = new PropertyManager("ticket.properties");
        } else {
            //if new filename is passed then recreate the object
            if (!filename.equals("ticket.properties")) {
                propertyManager = new PropertyManager("ticket.properties");
            }
        }
    ...
    public boolean update() {
        ...
        try {
            ...
            props.store(fos, "Generated sss settings");
            fos.close();
        } catch (IOException ex) {

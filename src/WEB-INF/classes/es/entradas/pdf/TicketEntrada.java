 ...
 * @author takuya
 */
public class TicketEntrada extends HttpServlet implements Serializable {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            /*if () {
                parametros.put("titulo", "Informe de mensajes le�dos");

            } else {
                parametros.put("titulo", "Informe de mensajes no le�dos");
            }*/
            parametros.put("LOGO", getServletContext().getRealPath("/media/logo_4.png"));

            reporte = (JasperReport) JRLoader.loadObject(
                    getServletContext().getRealPath("/WEB-INF/classes/es/entradas/jasper/TicketEntrada.jasper"));
    ...
    private TicketData getTickeData() {
        ...
        return (TicketData) sesion.getAttribute("ticketData");
    }

                        ...
                        <tr:panelBorderLayout>
                            ...
                            <tr:panelHorizontalLayout inlineStyle="width: 100%;">
                                ...
                                <tr:panelGroupLayout>
                                    ...
                                    <tr:panelHeader text="Clientes"/>
                                    <tr:spacer height="20px"/>
                                    <tr:outputText value="Desde esta pantalla los usuarios del sistema pueden gestionar a los clientes. El usuario puede tanto insertar datos de un cliente como modificar los datos de los mismos."/>
                                    <tr:spacer height="20px"/>
                                </tr:panelGroupLayout>
                            </tr:panelHorizontalLayout>
                        </tr:panelBorderLayout>
